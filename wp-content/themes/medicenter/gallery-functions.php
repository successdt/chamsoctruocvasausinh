		...
		if($type!="details")
		{
			...
			if($display_method=="dm_filters")
			{
				...
				$output .= '<ul class="tabs_navigation isotope_filters page_margin_top clearfix">
						<li>
							<a class="selected" href="#filter-*" title="' . __('All ' . ($shortcode_type=="gallery" ? 'Departments' : 'Doctors'), 'medicenter') . '">' . __('All ' . ($shortcode_type=="gallery" ? 'Departments' : 'Doctors'), 'medicenter') . '</a>
						</li>';
